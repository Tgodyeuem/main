...
local Tabs = {
    ...
    stack = Window:AddTab({ Title = "Tab Stack Auto Farm", Icon = "" }), 
    St = Window:AddTab({ Title = "Tab Status and Server", Icon = "" }),    
    Lc = Window:AddTab({ Title = "Tab Travel", Icon = "" }),  
    RC = Window:AddTab({ Title = "Tab Upgrade Race", Icon = "" }),
    Se = Window:AddTab({ Title = "Tab Sea Event", Icon = "" }),   
    pvp = Window:AddTab({ Title = "Tab Pvp-Visual", Icon = "" }),   
    cailon = Window:AddTab({ Title = "Tab Mirage + Kitsune", Icon = "" }),   
    spl = Window:AddTab({ Title = "Tab Player Status", Icon = "" }),   
    raid = Window:AddTab({ Title = "Tab Dungeon", Icon = "" }),
    De = Window:AddTab({ Title = "Tab Devil Fruits", Icon = "" }),    
    Ms = Window:AddTab({ Title = "Tab Misc", Icon = "" }),   
...
spawn(function()
    ...
    Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Auto CDK", Default = _G.Auto_Cursed_Dual_Katana })
    Toggle:OnChanged(function(Value)
  ...
  -- Yama Quest 1
  task.spawn(function()
    while getgenv().AutoCursedDual_Katana do task.wait()
      if YamaQuest_1 then
